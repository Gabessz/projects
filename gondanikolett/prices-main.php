		...
		<div class="row prices-row">
			<div class=" col-md-6">
				...
				<div class="price-text">
					<h3>Szabadtéri fotózás</h3>
					<a href="prices-outside.php"><button>Részletek</button></a>
			...
			<div class=" col-md-6">
				...
				<div class="price-text">
					<h3>Stúdió fotózás</h3>
					<a href="prices-studio.php"><button>Részletek</button></a>
